# coding=utf-8
# Copyright 2025 The Open-Sci Team, EleutherAI and the HuggingFace Inc. team. All rights reserved.
#
...
class OpenSciConfig(PretrainedConfig):
    ...
    Args:
        ...
        max_position_embeddings (`int`, *optional*, defaults to 2048):
            The maximum sequence length that this model might ever be used with. OpenSci 1 supports up to 2048 tokens,
            OpenSci 2 up to 4096, CodeOpenSci up to 16384.
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            Expected contents:
                `rope_type` (`str`):
                    ...
                    'opensci3'], with 'default' being the original RoPE implementation.
                `factor` (`float`, *optional*):
                    Used with all rope types except 'default'. The scaling factor to apply to the RoPE embeddings. In
                    most scaling types, a `factor` of x will enable the model to handle sequences of length x *
                    original maximum pre-trained length.
                `original_max_position_embeddings` (`int`, *optional*):
                    Used with 'dynamic', 'longrope' and 'opensci3'. The original max position embeddings used during
                    pretraining.
                ...
                `low_freq_factor` (`float`, *optional*):
                    Only used with 'opensci3'. Scaling factor applied to low frequency components of the RoPE
                `high_freq_factor` (`float`, *optional*):
                    Only used with 'opensci3'. Scaling factor applied to high frequency components of the RoPE
